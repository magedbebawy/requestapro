...
export default function BookingStep1() {
  ...
  if (serviceSlug === "tv-mounting") {
    return (
      <>
        <NextSeo
          title="TV Mounting | Book Professional Home Services"
          description="Book your TV mounting service with transparent pricing and professional installation."
          canonical="https://requestapro.com/book/step1"
          noindex={true}
          openGraph={{
            title: "TV Mounting | Book Professional Home Services",
            description:
              "Book your TV mounting service with transparent pricing and professional installation.",
            url: "https://requestapro.com/book/step1",
            type: "website",
          }}
        />
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    {[
                      ...
                      {
                        value: "in-wall",
                        label: "In-wall concealment (+$150)",
                      },
                      {
                        value: "external",
                        label: "External cord cover (+$50)",
                      },
                    ].map((option) => (
                      <label
                        key={option.value}
  ...
  if (serviceSlug === "smart-install") {
    return (
      <>
        <NextSeo
          title="Smart Home Installation | Book Professional Home Services"
          description="Book your smart home installation service with transparent pricing and professional installation."
          canonical="https://requestapro.com/book/step1"
          noindex={true}
          openGraph={{
            title: "Smart Home Installation | Book Professional Home Services",
            description:
              "Book your smart home installation service with transparent pricing and professional installation.",
            url: "https://requestapro.com/book/step1",
            type: "website",
          }}
        />
  ...
  if (serviceSlug === "furniture-assembly") {
    return (
      <>
        <NextSeo
          title="Furniture Assembly | Book Professional Home Services"
          description="Book your furniture assembly service with transparent pricing and professional installation."
          canonical="https://requestapro.com/book/step1"
          noindex={true}
          openGraph={{
            title: "Furniture Assembly | Book Professional Home Services",
            description:
              "Book your furniture assembly service with transparent pricing and professional installation.",
            url: "https://requestapro.com/book/step1",
            type: "website",
          }}
        />
  ...
  return (
    <>
      <NextSeo
        title="Choose Your Service | Book Professional Home Services"
        description="Select from our range of professional home services including TV mounting, smart home installation, and furniture assembly. Book your service online with transparent pricing."
        canonical="https://requestapro.com/book/step1"
        noindex={true}
        openGraph={{
          title: "Choose Your Service | Book Professional Home Services",
          description:
            "Select from our range of professional home services including TV mounting, smart home installation, and furniture assembly. Book your service online with transparent pricing.",
          url: "https://requestapro.com/book/step1",
          type: "website",
        }}
      />
